...
window.configure(background='#353335')
...
message3 = tk.Label(window, text="Face Recognition Based Attendance System",
                    fg="#F2F2F2", bg="#353335", width=55, height=1, font=('times', 29, ' bold '))
message3.place(x=10, y=10)

frame3 = tk.Frame(window, bg="magenta")
frame3.place(relx=0.52, rely=0.09, relwidth=0.09, relheight=0.07)

frame4 = tk.Frame(window, bg="brown")
frame4.place(relx=0.36, rely=0.09, relwidth=0.16, relheight=0.07)

datef = tk.Label(frame4, text=day+"-"+mont[month]+"-"+year+"  |  ", fg="#F2F2F2",
                 bg="#353335", width=55, height=1, font=('times', 22, ' bold '))
datef.pack(fill='both', expand=1)

clock = tk.Label(frame3, fg="#F2F2F2", bg="#353335", width=55,
                 height=1, font=('times', 22, ' bold '))
clock.pack(fill='both', expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ",
                 fg="black", bg="#F2F2F2", font=('times', 17, ' bold '))
...
lbl = tk.Label(frame2, text="Enter ID", width=20, height=1,
               fg="black", bg="grey", font=('times', 17, ' bold '))
lbl.place(x=80, y=55)
...
lbl2 = tk.Label(frame2, text="Enter Name", width=20, fg="black",
                bg="grey", font=('times', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2, width=32, fg="black", font=('times', 15, ' bold '))
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile", bg="grey",
                    fg="black", width=39, height=1, activebackground="white", font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="", bg="grey", fg="black", width=39,
                   height=1, activebackground="white", font=('times', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance", width=20, fg="black",
                bg="grey", height=1, font=('times', 17, ' bold '))
...
clearButton = tk.Button(frame2, text="Clear", command=clear, fg="white",
                        bg="#262523", width=11, activebackground="white", font=('times', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2, fg="white",
                         bg="#262523", width=11, activebackground="white", font=('times', 11, ' bold '))
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages, fg="white",
                     bg="#262523", width=35, height=1, activebackground="white", font=('times', 15, ' bold '))
trackImg.place(x=30, y=50)
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy, fg="white",
                       bg="#262523",
